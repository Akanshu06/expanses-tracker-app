...
form.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    const response = await axios.post(
      "https://expanses-tracker-app-r.onrender.com/user/addexpense",
      expenses,
      {
...
function getProducts(page) {
  ...
  axios
    .get(
      `https://expanses-tracker-app-r.onrender.com/user/getexpense?page=${page}`,
      { headers: { Authorization: token } }
    )
    .then((response) => {
...
async function deleteFunction(id) {
  ...
  try {
    await axios.delete(
      `https://expanses-tracker-app-r.onrender.com/user/deleteexpense/${id}`,
      { headers: { Authorization: token } }
    );
  } catch (error) {
...
premiumBtn.onclick = async (event) => {
  ...
  try {
    const response = await axios.get(
      "https://expanses-tracker-app-r.onrender.com/purchase/premiummembership",
      { headers: { Authorization: token } }
    );
    const options = {
      ...
      handler: async function (response) {
        const res = await axios.post(
          "https://expanses-tracker-app-r.onrender.com/purchase/purchasetransactionstatus",
          {
...
function showLeaderboard() {
  ...
  button.onclick = async () => {
    ...
    try {
      const response = await axios.get(
        "https://expanses-tracker-app-r.onrender.com/purchase/premiumFeature",
        { headers: { Authorization: token } }
      );
...
async function download() {
  ...
  try {
    const response = await axios.get(
      "https://expanses-tracker-app-r.onrender.com/user/download",
  ...
  // try {
  //     const URLs = await axios.get('https://expanses-tracker-app-r.onrender.com/user/geturl', { headers: { Authorization: token } });
