...
module.exports.forgetPassword = async (req, res) => {
  try {
    ...
    const info = await transporter.sendMail({
      ...
      html: `<a href="https://expanses-tracker-app-r.onrender.com/password/reset_password/${id}">Reset password</a>`,
    });
    ...
    return res
      .status(401)
      .json({ message: "Some issue in forgetPassword", success: false });
  }
};
